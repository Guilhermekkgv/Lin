...
Linux.ToggleIconAssetId = "rbxassetid://119686822323882"
...
function Linux.Create(config)
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob then
                    ...
                    if currentState then
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = Linux.Accents[Linux.CurrentAccent]}):Play()
    ...
    if config.ConfigSave ~= false then
        ...
        local toggleIconInput = SettingsTab.Input({
            Name = "Toggle Icon ID",
            Description = "Set a custom rbxassetid for the toggle button",
            Placeholder = "rbxassetid://119686822323882",
